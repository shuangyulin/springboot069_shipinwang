<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="播放量" prop="bofangliang">
          <el-input v-model="ruleForm.bofangliang" 
              placeholder="播放量" clearable  :readonly="ro.bofangliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="播放量" prop="bofangliang">
              <el-input v-model="ruleForm.bofangliang" 
                placeholder="播放量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="播放时长" prop="bofangshizhang">
          <el-input v-model="ruleForm.bofangshizhang" 
              placeholder="播放时长" clearable  :readonly="ro.bofangshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="播放时长" prop="bofangshizhang">
              <el-input v-model="ruleForm.bofangshizhang" 
                placeholder="播放时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="在线视频" prop="zaixianshipin">
          <file-upload
          tip="点击上传在线视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.zaixianshipin?ruleForm.zaixianshipin:''"
          @change="zaixianshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.zaixianshipin" label="在线视频" prop="zaixianshipin">
            <el-button type="text" size="small" @click="download(ruleForm.zaixianshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发布者" prop="fabuzhe">
          <el-input v-model="ruleForm.fabuzhe" 
              placeholder="发布者" clearable  :readonly="ro.fabuzhe"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发布者" prop="fabuzhe">
              <el-input v-model="ruleForm.fabuzhe" 
                placeholder="发布者" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shipinjianjie" label="视频简介" prop="shipinjianjie">
                    <span>{{ruleForm.shipinjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bofangliang = true;
          ...
          if(o=='bofangshizhang'){
            this.ruleForm.bofangshizhang = obj[o];
	    this.ro.bofangshizhang = true;
            continue;
          }
          if(o=='zaixianshipin'){
            this.ruleForm.zaixianshipin = obj[o];
	    this.ro.zaixianshipin = true;
            continue;
          }
          if(o=='fabuzhe'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shipinpaiming/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shipinpaimingCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    zaixianshipinUploadChange(fileUrls) {
	this.ruleForm.zaixianshipin = fileUrls;
			this.addEditUploadStyleChange()
    },
